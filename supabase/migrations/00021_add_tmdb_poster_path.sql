-- Add poster path column to videos table
ALTER TABLE videos ADD COLUMN IF NOT EXISTS tmdb_poster_path text;

-- Recreate feed_videos view to include poster path
